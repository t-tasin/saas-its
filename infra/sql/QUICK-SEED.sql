-- ============================================
-- QUICK SEED - Schema-Qualified Version
-- ============================================
-- Since you have schemas: identity, ticket, asset, reservation
-- Run this in Neon SQL Console (all in ONE database)
-- ============================================

-- ============================================
-- 1. SEED TICKETS (ticket schema)
-- ============================================
...
-- ============================================
-- 3. SEED RESERVATIONS (reservation schema)
-- ============================================
...
SELECT COUNT(*) AS ticket_count FROM ticket."Ticket";
SELECT COUNT(*) AS asset_count FROM asset."Asset";
SELECT COUNT(*) AS reservation_count FROM reservation."Reservation";

-- ============================================
-- SUCCESS!
-- ============================================
SELECT '✅ All seed data inserted successfully!' AS message;
