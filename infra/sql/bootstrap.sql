...
DO $$ BEGIN
   ...
   EXECUTE 'CREATE SCHEMA IF NOT EXISTS reservation AUTHORIZATION app';
END $$;

-- Grant app full access to all schemas
GRANT ALL ON SCHEMA identity, asset, ticket, reservation TO app;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA reservation GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO app;
