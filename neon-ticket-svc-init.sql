-- Database initialization script for ticket-svc on Neon
...
SELECT COUNT(*) as category_count FROM "ticket"."Category";
SELECT COUNT(*) as subcategory_count FROM "ticket"."SubCategory";
