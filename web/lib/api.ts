...
export const ticketApi = {
  ...
  getAnalytics: (days = 30) => api.get(`${TICKET_API}/analytics/tickets?days=${days}`),

  getRecentActivity: (limit = 10) => api.get(`${TICKET_API}/analytics/tickets/recent-activity?limit=${limit}`),
}
...
export const assetApi = {
  ...
  getAnalytics: () => api.get(`${ASSET_API}/analytics/assets`),

  getAging: () => api.get(`${ASSET_API}/analytics/assets/aging`),
}
...
export const reservationApi = {
  ...
  getAnalytics: (days = 30) => api.get(`${RESERVATION_API}/analytics/reservations?days=${days}`),
}
